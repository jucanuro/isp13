"""
Django settings for isp13 project.
...
SECRET_KEY = 'django-insecure-zu31%6*y-jccvq7^pftvtd%^e3&cn4cyo9l7k0s+g!j^z_91=*'
...
ALLOWED_HOSTS = []
ALLOWED_HOSTS = [
    '13dejuliode1882sp.edu.pe',
    'www.13dejuliode1882sp.edu.pe',
    'localhost',
    '127.0.0.1',
]
